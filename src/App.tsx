...
import { Home, NotFound404, CreateAccount, CreateFood, Trainers, WatchTrainerVideo, TrainersDetails, LogIn, Profile, FoodView, FoodAnalysis, Preview, Messages, Matches, Search } from './components';
